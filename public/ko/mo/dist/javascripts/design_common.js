...
function join() {
   ...
   var swiper = new Swiper(".silde_photo_wrap", {
      ...
      loop: false,
      navigation: {
         nextEl: ".silde_photo_wrap .swiper-button-next",
         prevEl: ".silde_photo_wrap .swiper-button-prev",
      },
   });
   ...
   var swiper = new Swiper(".silde_big_photo_wrap", {
      ...
      loop: false,
      navigation: {
         nextEl: ".silde_big_photo_wrap .swiper-button-next",
         prevEl: ".silde_big_photo_wrap .swiper-button-prev",
      },
      pagination: {
         el: ".silde_big_photo_wrap .review_pagination",
         type: "fraction",
      },
   });
